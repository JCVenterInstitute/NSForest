...
Requirements (please read carefully to avoid errors)

-The script is a Jupyter notebook in python 2.7. Required libraries: Numpy, Pandas, Sklearn, graphviz, numexpr
-The input is a tab delimited expression Cell x Gene matrix with one column containing the cluster assignments 
...
-The gene identifiers used must avoid special characters such as ./-/@ or beginning with numbers 
(I prefix identifiers beginning with numbers and substitute all special characters with "_")
...
After the best pair of genes is found, the remaining 8 genes are tested in third position, and onward for until the analysis reaches
a 6 gene combination.   
