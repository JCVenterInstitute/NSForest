...
def NSForest(adata, cluster_header, medians_header, binary_scores_header, 
    ...
    # on_target_fraction(adata, markers_dict, cluster_header, medians_header, output_folder, outputfilename)
    markers_dict = dict(zip(df_results["clusterName"], df_results["NSForest_markers"]))
    on_target_ratio = calculate_fraction.on_target_fraction(adata, markers_dict, cluster_header, medians_header, output_folder, outputfilename)
