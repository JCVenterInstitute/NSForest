...
def DecisionTree(adata, cluster_header, medians_header, 
    ...
    on_target_ratio = calculate_fraction.markers_onTarget(adata, markers_dict, cluster_header, medians_header, output_folder, outputfilename)
...
def add_fraction(adata, df_results, cluster_header, medians_header, use_mean = False, output_folder = "", outputfilename = ""): 
    markers_dict = dict(zip(df_results["clusterName"], df_results["markers"]))
    # markers_onTarget(adata, markers_dict, cluster_header, medians_header, use_mean = False, output_folder = "", outputfilename = "")
    on_target_ratio = calculate_fraction.markers_onTarget(adata, markers_dict, cluster_header, medians_header, use_mean, output_folder, outputfilename)
