...
def NSForest(adata, cluster_header, cluster_list=None,
    ...
    for cl in cluster_list:
        ...
        print("saving file as " + output_folder + outputfilename + "_supplementary.csv")
        ...
        print("saving file as " + output_folder + outputfilename + "_markers.csv")
        ...
        print("saving file as " + output_folder + outputfilename + "_results.csv")
